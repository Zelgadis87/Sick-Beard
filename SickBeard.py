...
def help_message():
    ...
    help_msg += "                --locale=<locale>   Uses the given locale instead of the one specified by the system \n"
...
def main():
    ...
    try:
        opts, args = getopt.getopt(sys.argv[1:], "hfqdp::", ['help', 'forceupdate', 'quiet', 'nolaunch', 'daemon', 'pidfile=', 'port=', 'datadir=', 'config=', 'noresize', 'locale='])  # @UnusedVariable
