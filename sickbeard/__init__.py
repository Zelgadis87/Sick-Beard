...
IGNORE_WORDS = "german,french,core2hd,dutch,swedish,480p,vostfr"
...
def initialize(consoleLogging=True):
    ...
    with INIT_LOCK:
        ...
        global ACTUAL_LOG_DIR, LOG_DIR, WEB_PORT, WEB_LOG, WEB_ROOT, WEB_USERNAME, WEB_PASSWORD, WEB_HOST, WEB_IPV6, USE_API, API_KEY, ENABLE_HTTPS, HTTPS_CERT, HTTPS_KEY, \
                ...
                QUALITY_DEFAULT, FLATTEN_FOLDERS_DEFAULT, STAY_AHEAD_DEFAULT, STATUS_DEFAULT, \
                ...
                USE_PUSHBULLET, PUSHBULLET_APIKEY, PUSHBULLET_DEVICE, PUSHBULLET_NOTIFY_ONDOWNLOAD, PUSHBULLET_NOTIFY_ONSNATCH, \
        ...
        HIDE_TVSHOW_STATUS = bool(check_setting_int(CFG, 'General', 'hide_tvshow_status', 0))
        ...
        STAY_AHEAD_DEFAULT = check_setting_int(CFG, 'General', 'stay_ahead_default', 1)
...
def save_config():
    ...
    new_config['General']['hide_tvshow_status'] = int(HIDE_TVSHOW_STATUS)
